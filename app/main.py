...
PORTFOLIO_DATA = {
    ...
    "social": {
        ...
        "linkedin": {
            "url": "https://linkedin.com/in/rakibulhasan",
            "label": "LinkedIn",
            "username": "in/rakibulhasan"
        },
        "huggingface": {
            "url": "https://huggingface.co/rakibulhasan",
            "label": "Hugging Face",
            "username": "@rakibulhasan"
        },
        "huggingface_org": {
            "url": "https://huggingface.co/rakibul-ai-lab",
            "label": "HF Organization",
            "username": "rakibul-ai-lab"
        },
        "email": {
            "url": "mailto:rakibul.hasan@example.com",
            "label": "Email",
            "username": "rakibul.hasan@example.com"
        },
        "whatsapp": {
    ...
    "stats": [
        {"number": "12+", "label": "Years in ML/AI"},
        {"number": "25+", "label": "Team Members Led"},
        {"number": "50M+", "label": "Daily Predictions"},
        {"number": "8", "label": "Production Systems"}
    ],
    "expertise": [
        {
    ...
    "certifications": [
        ...
        {"name": "NVIDIA Deep Learning Institute", "issuer": "NVIDIA"}
    ]
}
